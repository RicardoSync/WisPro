...
def getDatos(usuarioEntry, passwordEntry, ventana):
    ...
    if credenciales:
        ...
        if rol == 0:
            panelAdmin(username, id_usuario, ventana)
        elif rol == 1:
...
def inicioSesion(windows):
    ...
    contenedorElementos = CTkFrame(ventana, border_color=colores["marcos"], border_width=2,
    ...
    btnIniciar = CTkButton(contenedorElementos, border_color=colores["marcos"], border_width=2,
                        ...
                        text_color="black",
                        text="Iniciar Sesión",
                        command=lambda:getDatos(usuarioEntry, passwordEntry, ventana))
